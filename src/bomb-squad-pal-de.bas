...
_labels(0)=&"rot" : _labels(1)=&"rot gestreift"
_labels(2)=&"blau" : _labels(3)=&"blau gestreift"
_labels(4)=&"gr"$0A"n" : _labels(5)=&"gr"$0A"n gestreift"
...
PROC _ChangePage _diff
    ...
    IF _pg
        ...
        PRINT "Bombe ";_pg;" (";_manual_num_wires;" Dr"$0B"hte)"
        ...
        FOR W=0 TO _manual_num_wires-1
            ...
            POS. 17, Y + W
            IF _order THEN PRINT "- ";_order;". Schnitt";
        NEXT
    ELSE
        PRINT "BOMBENENTSCH"$7B"RFUNG"
    ENDIF
ENDPROC
...
PROC _DrawBomb
    ...
    FOR W=0 TO _num_wires-1
        ...
        IF _bomb & 1 THEN MSET _screen_mem + 120 + W * 80, 40, 15
    NEXT
ENDPROC
